      ...
      <div class="my-profile" >
         <div class="my-profile-bd">
            ...
            <div class="my-profile-item">
               ...
               <div class="my-profile-item-info"><span class="gray">{{Auth::user()->phone ?? 'Vui lòng nhập số điện thoại của bạn'}} </span></div>
            </div>  
         </div>
         ...
         <a href="{{ route('get.user.change_password') }}" class="next-btn next-btn-warning next-btn-normal next-btn-large">THAY ĐỔI MẬT KHẨU</a></div>
      </div>
   </div>
</div>
@stop