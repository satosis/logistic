               ...
               <div class="edit-profile-item">
                  ...
                  <div class="edit-profile-item-info">
                     <div class="mod-input floating edit-profile-input-name mod-input-name">
                        <input type="text" name="name" id="name" placeholder="Họ Tên" value="{{ \Auth::user()->name }}"><b></b>
                     </div>
                  </div>
               </div>
               <div class="edit-profile-item">
                  ...
                  <div class="mod-input floating  edit-profile-item-value"><input type="text" readonly name="email" placeholder="Email"  value="{{ \Auth::user()->email }}"></div>
               </div>
               <div class="edit-profile-item">
                  <h3 class="edit-profile-item-title">
