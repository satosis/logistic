...
<div class="lzd-playground-right">
   ...
   <div id="container" class="container">
      <div class="wishlist-container">
         <div class="mod-header-tab"><a href="{{route('get.user.favourite') }}" class="active">Danh sách yêu thích<span>(1)</span></a> <a href="#" class="">Sản phẩm đã theo dõi</a></div> 
         <div>
            <div >
                     ...
                     <div class="shop-items">
                        <div class="mod-main">
                           <div class="wishlist-item"> 
                              ...
                              <div class="price">
                              @if($list->pro_sale)
                                 <div class="currPrice">₫ {{ number_format($list->pro_price,$list->pro_sale )}}</div>
                                 <div class="originPrice"><span class="origin-price-value">₫ {{ number_format($list->pro_price,0) }}</span><span class="promotion">-{{ $list->pro_sale}}%</span></div> 
                        @else
                        <div class="currPrice">₫ {{ number_format($list->pro_price,0)}}</div>
                               
                                @endif
                              </div>
                              <div class="right-oper"><img src="//laz-img-cdn.alicdn.com/tfs/TB1iUYumfDH8KJjy1XcXXcpdXXa-144-64.png" width="72" height="32"></div>
                           </div>
                        </div>
                     </div>
                     @endforeach
