...
@extends('layout.user')
@section('profile')
<style>td span{font-size:12px}</style><div class="lzd-playground-right">
      ...
      <div class="book" >
         <div>
            <div class="mod-address-book">
                           ...
                           @if(isset(\Auth::user()->location)) 
                              <tr class="next-table-row last first">
                                 ...
                                 <td class="next-table-cell last">
                                    <div class="next-table-cell-wrapper"><a href="{{ route('get.user.edit_address')}}" class="next-btn next-btn-text next-btn-primary next-btn-medium" >Chỉnh sửa</button></div>
                                 </td>
                              </tr>@endif
               ...
               <div class="mod-address-book-ft"><a href="{{ route('get.user.edit_address')}}" class="next-btn next-btn-warning next-btn-normal next-btn-large">+ Thêm địa chỉ mới</a></div>
            </div>
