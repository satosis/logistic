...
<div id="container">
   <div class="wrp"> 
      <div id="product" class="cart">
         <div class="flex">
            <div class="left">
               <div class="cart_header" style="text-align: center;color: #288ad6;">THÔNG TIN GIỎ HÀNG( {{\Cart::count()}} sản phẩm)</div>
               <form name="frm_cart" action="" method="post">
                  ...
                  <div class="btnCartGroup tac" style="margin-top: 30px;">
                     <a href="{{route('get.home')}}" class="btnCart"  style="background: #3498db;padding: 10px 15px;color: #FFF;border-radius: 25px;text-transform: uppercase;">Mua thêm sản phẩm khác <i class="fas fa-arrow-right"></i></a>
                  </div>
               </form>
            </div>
                  ...
                  <div class="form">
                      <form class="from_cart_register" action="{{ route('post.shopping.pay') }}" method="post">
                        ...
                        <div class="item">
                           ...
                           <input type="text" name="tst_address" value="Hà Nội" id="tst_address" autocomplete="off" placeholder="Nhập địa chỉ" />
                        </div>
                        <div class="item">
                        ...
                        <div class="btnThanhToan">
                           ...
                           <button class="tac" type="submit" value="2" name="submit">
                              <p class="ttu fHelveticaNeueB fs15">Thanh toán bằng PAYPAL</p>
                           </button> 
