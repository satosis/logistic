...
<div class="content-wrapper">
  ...
  <div class="form-group {{ $errors->first('k_name') ? ' has-error':'' }}"  >
    ...
    <input type="text" name ="k_name" class="form-control" id="exampleInputEmail1" value="{{$keyword->k_name}}" aria-describedby="emailHelp">
  ...
  <div class="form-group {{ $errors->first('k_description') ? ' has-error':'' }}"  >
    ...
    <input type="text" name ="k_description" class="form-control" id="exampleInputEmail" value="{{$keyword->k_description}}" aria-describedby="emailHelp">
