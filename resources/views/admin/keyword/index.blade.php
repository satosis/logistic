...
<div class="content-wrapper">
    ...
    <tbody>
      ...
      <td> 
      <a href="{{route('admin.keyword.update',$list->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> Sửa</a>
      <a href="{{route('admin.keyword.delete',$list->id) }}" class="js-query-confirm btn btn-danger"><i class="fa fa-times"></i> Xóa</a>
    </td>
    </tbody>
    @endforeach
    </table>
