      ...
      <form action="" role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
          <div class="box box-warning">
            ...
            <div class="box-body">
              <div class="form-group {{$errors->first('pro_name') ?'has-error' : ''}}"><label for="email">Tên sản phẩm</label>
              <input type="text" class="form-control" name="pro_name" id="email" value="{{  $product->pro_name ?? old('pro_name') }}" placeholder="Iphone 5s..." autocomplete="off">
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group {{$errors->first('pro_price') ?'has-error':'' }}">
                  ...
                  <input type="text" class="form-control" value="{{ $product->pro_price ?? old('pro_price') }}" name="pro_price" id="pass" placeholder="2.000.000" autocomplete="off">
              ...
              @foreach($image as $item)
                <div class="col-sm-2"><a href="{{ route('admin.product.delete_image',$item->id)}}" style="display:block">
                <img src="{{ pare_url_file($item->al_slug)}}" style="width:80px;height:100px;object-fit:cover"></a></div>
              @endforeach
              </div>
              @endif
              <div class="box-header with-border">
            ...
            <div class="form-group {{$errors->first('pro_description') ?'has-error':''}}">
              ...
              <textarea name="pro_description" id="des" cols="5" rows="2" autocomplete="off" class="form-control">{{$product->pro_description ?? old('pro_description',"Đang cập nhật")}}</textarea>
        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
            <div class="form-group {{$errors->first('pro_content') }}">
              <textarea name="pro_content" id="content">{{ $product->pro_content ?? old('pro_content',"Content") }}</textarea>
