...
<div class="content-wrapper">
    ...
    <tbody>
      ...
      <td>{{$list->pro_view }}</td>
      <td> 
      <a href="{{route('admin.product.update',$list->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> Sửa</a>
      <a href="{{route('admin.product.delete',$list->id) }}" class="btn btn-danger js-query-confirm" ><i class="fa fa-times"></i> Xóa</a>
    </td>
    </tbody>
    @endforeach
    </table>
