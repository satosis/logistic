                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="a_menu_id" id="fs" class="form-control">
                                    ...
                                    <option value="KIẾN THỨC ĐỒNG HỒ" {{ ($article->a_menu_id ?? '') == 'KIẾN THỨC ĐỒNG HỒ' ?"selected='selected'" : ''}}>
                                        KIẾN THỨC ĐỒNG HỒ
                                    </option>
                                    <option value="KIẾN THỨC KÍNH MẮT" {{ ($article->a_menu_id ?? '') == 'KIẾN THỨC KÍNH MẮT' ?"selected='selected'" : ''}}>
                                        KIẾN THỨC KÍNH MẮT
                                    </option>
                                    <option value="HỎI ĐÁP VỀ ĐỒNG HỒ" {{ ($article->a_menu_id ?? '') == 'HỎI ĐÁP VỀ ĐỒNG HỒ' ?"selected='selected'" : ''}}>
                                        HỎI ĐÁP VỀ ĐỒNG HỒ
                                    </option>
                                    <option value="BÁO CHÍ VIẾT VỀ ĐĂNG QUANG" {{ ($article->a_menu_id ?? '') == 'BÁO CHÍ VIẾT VỀ ĐĂNG QUANG' ?"selected='selected'" : ''}}>
                                        BÁO CHÍ VIẾT VỀ ĐĂNG QUANG
                                    </option>
