...
<div class="content-wrapper">
  ...
  <div class="form-group {{ $errors->first('atb_name') ? ' has-error':'' }}"  >
    ...
    <input type="text" name ="atb_name" value="{{ $attributes->atb_name }}" class="form-control" id="exampleInputEmail1">
  ...
  <div class="form-group {{ $errors->first('atb_type') ? ' has-error':'' }}"  >
    ...
    <option value="2" {{ $attributes->atb_type == 2 ? "selected='selected'" : ''}}>Năng lượng</option>
