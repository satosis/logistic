...
<div class="content-wrapper">
    ...
    <tbody>
      ...
      <td> 
      <a href="{{route('admin.attribute.update',$list->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i> Sửa</a>
      <a href="{{route('admin.attribute.delete',$list->id) }}" class="btn btn-danger js-query-confirm" ><i class="fa fa-times"></i> Xóa</a>
    </td>
    </tbody>
    @endforeach
  @endif
