      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="{{ route('admin.transaction.index') }}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="{{ route('admin.rating')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="box box-solid bg-teal-gradient">
            ...
            <div class="box-body border-radius-none">
              ...
              <figure class="highcharts-figure">
                  <div id="container2" data-json={{ $listDay }} 
    ...
    <div id="container" data-json="{{$statusTransaction}} "></div>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Top sales</h3>
              ...
              <div class="table-responsive">
               ...
               @foreach($hotProduct as $value=>$list)   
                  <tr>
                    ...
                    <td>{{$list->id}}</a></td>
                    <td>{{ $list->pro_name }}</td>
                    <td><img src="{{ pare_url_file($list->pro_avatar) }}" style="width:40px;height:40px;object-fit:contain"></td>
